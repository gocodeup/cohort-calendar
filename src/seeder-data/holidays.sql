...
VALUES ('New Years','2021-01-01'),
       ...
       ('Staff Development Day','2021-01-29'),
       ('Staff Development Day','2021-02-26'),
       ('Department off-sites','2021-03-26'),
       ('Good Friday','2021-04-02'),
       ('Staff Development Day','2021-04-30'),
       ('Staff Development Day','2021-05-28'),
       ('Memorial Day','2021-05-31'),
       ('Department Off-sites','2021-06-24'),
       ('All Staff Day','2021-06-25'),
       ('Independence Day 1','2021-07-02'),
       ('Independence Day 2','2021-07-05'),
       ('Staff Development Day','2021-07-30'),
       ('Staff Development Day','2021-08-27'),
       ('Labor Day','2021-09-06'),
       ('Department Off-sites','2021-09-24'),
       ('Indigenous Peoples Day','2021-10-11'),
       ('Staff Development Day','2021-10-29'),
       ('Veterans Day/All Staff Day','2021-11-11'),
       ('Thanksgiving Break Day 1','2021-11-24'),
       ('Thanksgiving Break Day 2','2021-11-25'),
       ('Thanksgiving Break Day 3','2021-11-26'),
       ('Department Off-Sites','2021-12-17'),
       ('Winter Break Day 1','2021-12-20'),
       ('Winter Break Day 2','2021-12-21'),
       ('Winter Break Day 3','2021-12-22'),
       ('Winter Break Day 4','2021-12-23'),
       ('Winter Break Day 5','2021-12-24'),
       ('Winter Break Day 6','2021-12-27'),
       ('Winter Break Day 7','2021-12-28'),
